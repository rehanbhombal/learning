#use this script to get Permission structure(Including Library, Folder level) of SharePoint site
...
Add-Type -Path "C:\Program Files\Common Files\Microsoft Shared\Web Server Extensions\16\ISAPI\Microsoft.SharePoint.Client.Runtime.dll"
  ...
  $pLoadCSOMProperties="$PSScriptRoot\Load-CSOMProperties.ps1"
 . $pLoadCSOMProperties
...
$RootSiteTitle="";
$ExportFileDirectory = "$PSScriptRoot";
    ...
    { 
       ...
       { 
           ...
           #get all items 
            ...
            Write-Host "Listitem Count:" $collListItem.Count 
...
if(Test-Path $ExportFileDirectory){
  ...
  $ctx.ExecuteQuery()
   ...
   $Permissions|Select SiteUrl,SiteTitle,Type,RelativeUrl,ListTitle,MemberType,MemberName,MemberLoginName,ParentGroup,Roles|Export-CSV -Path $exportFilePath -NoTypeInformation -Encoding UTF8 -Delimiter ';'
}
else{
